...
class ExerciseEighthSectionScreen extends StatelessWidget {
  const ExerciseEighthSectionScreen({super.key});

  static const String route = '/exercise-eighth-section';
  ...
  Widget build(BuildContext context) {
    return ExerciseScaffold(
      onActionButtonPressed: () async {
        var success = await openUrl(exerciseSevenUrl);
